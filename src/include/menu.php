...
$menu = array("it" => array("HOME","COMPETENZE","ESPERIENZE","FILOSOFIA","DIVERTIMENTO","DOCUMENTI","CLIENTI"),"en" => array("HOME","SKILLS","EXPERIENCES","PHILOSOPHY","FUN","DOCUMENTS","CUSTOMERS"));
?>
<h4>

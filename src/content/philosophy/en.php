...
<section>
    ...
    <hr /> <!-- 344 -->
    A344 - If you have animal poison at home or that you want to get rid of, it can most likely be safely used as fertilizer for plants or trees diluted in water. I say this because there is a long list of fertilizing substances and I would not be surprised if these could also be used for the same purpose.
    <hr /> <!-- 345 -->
    A345 - "Tattoo recalibration" is a psychological technique that consists of recalibrating the meanings associated with a tattoo (or parts of it when possible). You must analyze the tattoo on your body in its parts and re-associate the meanings you prefer to them. In this way it is possible to exploit it dynamically in different situations and for different purposes (probably both personal and work). If you decide to use this technique and in the past you have spread a meaning to third parties, refer to this portal and talk about "tattoo recalibration" to indicate that all the meanings you have mentioned in the past are no longer valid and that the only thing that you show to others is only the part drawn on the skin (let at least a week pass before using this technique). If you decide to use this technique I recommend dedicating at least 10 minutes to think about it calmly and if necessary take some notes to keep, for example in your wallet, on your decisions in this regard if you want to do it by yourself. You can also keep some "cards" with you and change the meaning you intend to use to your liking. You can also optionally combine non-permanent tattoos as an accessory to the permanent one if necessary, but remember that it is necessary to have the permanent one as a fixed reference and that its design must be clearly shown to people on social networks to work: the more the the larger the audience, the greater the intensity. Possibly, if you want to find more useful and intelligent meanings, you can ask for paid consultancy from third parties if they decide to offer this type of specific service (called "tattoo recalibration consultancy"). This technique cannot be used without the use of a permanent tattoo, and it is however important to remember that the power of the tattoo cannot be easily varied: few views, little intensity, many views, a lot of intensity. Publicly mentioning the use of tattoo recalibration can protect you from the effects of judgment that people may have associated with your tattoo.
    <hr /> <!-- 346 -->
    A346 - I have found that some phenomena, even distant and different from each other, are sometimes mysteriously and inexplicably connected perfectly to each other. This concept essentially applies to the basic concept of 'information', which can be either something easily observable and measurable, or something mysterious and mystical and which we 'feel' on an internal level. There is already a specific word to define this concept, but I cannot add it. What happens in some cases is that these information or events "hook" together, also based on how we behave.
    <hr /> <!-- 347 -->
    A347 - The repairability of particular "faults" or the possibility of solving certain problems (of various types) is not absolute but relative. Relating to the presence of sufficient resources of certain types. Hypothetically, if we erased all information relating to electronics from the planet (the specifications of the components and their function...), repairing a banal digital watch in a reasonable time would become essentially impossible. In addition to this, however, it is also important to say that sometimes what seems like a loss for a particular person that is impossible to heal or fill, with the right knowledge and some resources can be fixed, and that therefore essentially, the cost of the repair also varies depending on function of the knowledge available regarding the problem itself.
    <hr /> <!-- 348 -->
    A348 - When building dams for the production of electricity, it is important to also provide elevators that fish can use to descend (and ascend, when required, for example for salmon) the dam. Generally, however, any system that produces electricity must be designed to reduce the impact on the various forms of life in general as much as possible, insofar as it is possible to do so.
    <hr /> <!-- 349 -->
    A349 - The effect that particular information (e.g. read) has on our mind depends on our health. In certain cases, some information is dispersed in our organism as soon as we read it as it acts as a 'stopgap', whereas if our level of health is sufficient then it remains memorized and we can use it as we wish, even teaching it to others.
    <hr /> <!-- 350 -->
    A350 - Some transactions are extremely safe to carry out (e.g. walking to a nearby shop and buying a fruit with money) while others are not (e.g. when operating in certain areas using IT tools and from far away). Depending on how we relate to carrying out the transaction, the final result of the "purchase" could be more or less improving. For example, buying newly developed dynamite without absolutely knowing how to use it could lead to disastrous results (assuming for example that it doesn't explode when you light the fuse, but with a scream...).
    <hr />
    <div class="note">
